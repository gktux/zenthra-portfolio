...
export default function MissionVision() {
  ...
  return (
    <section id="mission" className="section-padding" style={{ background: '#fbfbfd', borderTop: '1px solid rgba(0,0,0,0.06)' }}>
      <div className="container">
        ...
        <ScrollReveal distance="40px" duration="0.8s">
          <div style={{ textAlign: 'center', maxWidth: '750px', margin: '0 auto 60px auto' }}>
            ...
            <p style={{ color: '#86868b', fontSize: '1.05rem', fontFamily: "var(--font-body)" }}>
        ...
        <div className="grid-2" style={{ marginBottom: '60px' }}>
          ...
          <ScrollReveal delay={0.1} distance="50px" duration="0.85s">
            <div className="cuberto-card" style={{ background: '#ffffff', padding: '48px', height: '100%' }}>
              ...
              <p style={{ color: '#6e6e73', fontSize: '1.05rem', lineHeight: 1.7, fontFamily: "var(--font-body)" }}>
          ...
          <div className="grid-4" style={{
            ...
            {t.missionVision.stats.map((stat, idx) => (
              <div key={idx} style={{ padding: '16px' }}>
                <div style={{ fontSize: '2.5rem', fontWeight: 600, fontFamily: "var(--font-display)", marginBottom: '6px' }}>
                  {stat.value}
                </div>
                <div style={{ color: '#86868b', fontSize: '0.9rem', fontWeight: 500, fontFamily: "var(--font-body)" }}>
                  {stat.label}
                </div>
              </div>
            ))}
